...
The timing regression now pins 0/200/400/600/800/1000ms boundaries and the 200ms step, and failed on the 0.1.20 code before the change. Core, desktop, view, female-idle, attack-motion, real-window app, full build and clean-extraction startup checks pass. Version 0.1.21.0 is packaged as `dist/DesktopPet-Windows-x64-0.1.21.zip`; ZIP SHA256: `B849458522B94791122BB4F2AAE2C9A65F2F0725DBC5CCC0E2DBBAC0C7A78744`. The unreleased local 0.1.20 artifact is superseded and was removed from `dist/`.
